...
describe('basic', function() {
  ...
  it('should set Content-Type', function(done) {
    ...
    request(app).get('/index.js')
        .expect('Content-Type', 'application/javascript').expect(200, done);
  });
  ...
  it('should support index.html', function(done) {
    ...
    request(app).get('/test').expect('Content-Type', /html/).expect(200, done);
  });
  ...
  it('should support conditional requests', function(done) {
    ...
    request(app).get('/index.js').end(function(err, res) {
  ...
  it('should set max-age=0 by default', function(done) {
    ...
    request(app).get('/index.js').expect('cache-control', 'public, max-age=0')
        .expect(200, done);
  });
